    ...
    return (
        <div className="bg-colorful footer-main py-3 ">
            ...
            <div className=" d-flex justify-content-center  text-light">
                @2021 <span className="project-name mx-2"> SUSASTHO </span> - All Rights reserved. Created By <span className="creator-name mx-2"> <a href="https://hanif.netlify.app/" target="_blank">M.A.HANIF</a> </span>
            </div>
